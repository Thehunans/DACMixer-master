...
labels = [
    ...
    Label(  'parking'              ,  9 ,      16 , 'flat'            , 1       , False        , True         , (250,170,160) ),
    Label(  'rail track'           , 10 ,      16 , 'flat'            , 1       , False        , True         , (230,150,140) ),
    ...
    Label(  'guard rail'           , 14 ,      16 , 'construction'    , 2       , False        , True         , (180,165,180) ),
    Label(  'bridge'               , 15 ,      16 , 'construction'    , 2       , False        , True         , (150,100,100) ),
    Label(  'tunnel'               , 16 ,      16 , 'construction'    , 2       , False        , True         , (150,120, 90) ),
    Label(  'pole'                 , 17 ,        4 , 'object'          , 3       , False        , False        , (153,153,153) ),
    Label(  'polegroup'            , 18 ,      16 , 'object'          , 3       , False        , True         , (153,153,153) ),
    ...
    Label(  'rider'                , 25 ,        9 , 'human'           , 6       , True         , False        , (255,  0,  0) ),
    ...
    Label(  'caravan'              , 29 ,       16 , 'vehicle'         , 7       , True         , True         , (  0,  0, 90) ),
    Label(  'trailer'              , 30 ,       16 , 'vehicle'         , 7       , True         , True         , (  0,  0,110) ),
    ...
    Label(  'license plate'        , -1 ,       16 , 'vehicle'         , 7       , False        , True         , (  0,  0,142) ),
]
...
cityscapes_data_path = "D:/TheHuns-code/data/cityscapes"
cityscapes_meta_path = "D:/TheHuns-code/data/cityscapes"
